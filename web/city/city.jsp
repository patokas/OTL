    ...
    <head>
        ...
        <script type="text/javascript">
            function changeDisplay() {
                if (document.formFilter.filter.value == 1) {
                    text.style.display = 'none';
                }
                if (document.formFilter.filter.value == 2) {
