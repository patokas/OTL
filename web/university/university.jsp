                                            ...
                                            <table id="datatable" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>ID Universidad <i class="fa fa-sort"></i></th>
                                                        <th>Nombre Universidad <i class="fa fa-sort"></i></th>
                                                        <th></th>
                                                        <th></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <c:forEach var="list" items="${list}"> 
                                                        <tr>
                                                            <th><input type="checkbox" name="chk" value="<c:out value="${list.idUniversity}" />"/></th>
                                                            <td class="center"><c:out value="${list.idUniversity}" /></td>
                                                            <td class="center"><c:out value="${list.nameUniversity}" /></td>
                                                            <td class="center">
                                                                <a href="UniversityGetServlet?idUniversity=<c:out value="${list.idUniversity}" />"><button class="btn btn-primary btn-mini" name="btnUpOne" type="button"><strong><font size="1">ACTUALIZAR</font></strong></button></a>                                                                
                                                            </td>
                                                            <td class="center">
                                                                <form action="UniversityMainServlet" method="post"> 
                                                                    <button class="btn btn-danger btn-mini delete" name="btnDelRow" type="submit"><strong><font size="1">ELIMINAR</font></strong></button>
                                                                    <input type="hidden" name="idUniversity" value="<c:out value="${list.idUniversity}" />">
                                                                </form>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>                                                                                		                                    		
